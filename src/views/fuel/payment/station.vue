    ...
    export default {
        ...
        methods: {
            ...
            Download(type) {
              ...
              window.open('http://sichuan.95504.net/v4/console/bill/payReportStation?' + 'token=' + token +'&time_type=' + time_type + '&time_start=' + time_start + '&time_end=' + time_end + '&station_code=' + this.id + '&order_type=' + order_type + '&is_export=1');
            },
            onChange(current) {
              const _this = this;
              const time_type = _this.time_type;
